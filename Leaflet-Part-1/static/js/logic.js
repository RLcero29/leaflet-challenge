...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  function getColor(depth) {
    if (depth < 10) return "#e5f5e0"
    else if (depth >= 10 & depth < 30) return "#a1d99b"
    else if (depth >= 30 & depth < 50) return "#31a354"
    else if (depth >= 50 & depth < 70) return "#ffeda0"
    else if (depth >= 70 & depth < 90) return "#feb24c"
